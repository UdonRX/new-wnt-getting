...
const FINGERPRINT_VERSION = 'fingerprint-filter-v3-lazy-carousel';
...
function installLongSearchWait() {
  if (window.__PDV2_READER_DEEP_LONG_WAIT_INSTALLED_V3) return;
  window.__PDV2_READER_DEEP_LONG_WAIT_INSTALLED_V3 = true;
