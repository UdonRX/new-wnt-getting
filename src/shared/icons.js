const PATHS = {
  ...
  sns: '<circle cx="6.5" cy="7" r="2.5"/><circle cx="17.5" cy="7" r="2.5"/><circle cx="12" cy="17" r="2.5"/><path d="M8.7 8.3 10.8 14.7M15.3 8.3l-2.1 6.4M9 7h6"/>',
  instagram: '<rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.4" cy="6.6" r="1" style="fill:currentColor;stroke:none"/>',
