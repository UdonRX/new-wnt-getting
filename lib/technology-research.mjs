...
const NOTE_LOW_VALUE_RE=/(市場レポート|市場規模|市場シェア|CAGR|QYResearch|市場調査|調査レポート|グローバル.*市場)/i;
